				...
				<article class="container" id="top">
					<div class="row">
						<div class="4u 12u(mobile)">
							<span class="image fit"><img src="images/pic1.jpg" alt="" /></span>
						</div>
						<div class="8u 12u(mobile)">
							<header>
								<h1>Hi. I'm <strong>Lorraine Lewis</strong>.</h1>
							</header>
							<p>Welcome to my <strong>Real-Estate</strong> Site.</p>
		...
		<!-- Portfolio -->
			<div class="wrapper style3">
				<article id="portfolio">
					...
					<div class="container">
						<div class="row">
							<div class="4u 12u(mobile)" id="fileupload">
							...
							<div class="4u 12u(mobile) fileupload">
								<article class="box style2">
